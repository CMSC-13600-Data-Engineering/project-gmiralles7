...
urlpatterns = [
    ...
    path('getUploads', views.getUploads, name='getUploads'), # qr_upload: localhost:8000/getUploads
    #path('getUploads_submit', views.qr_upload_submit, name='qr_upload_submit'),
]
